          ...
          setTimeout(() => {
            try {
              let slots = Array.from(
                document.querySelectorAll(".sc-kpOJdX.eVDhEX.css-r99fas"),
              ).map((el) => el.innerText);
              ...
              try {
                pct1 = parseFloat(
                  document.querySelector(".sc-kpOJdX.eVDhEX.css-1o79l0z")
                    .innerText,
                );
              } catch (e) {
                pct1 = 0;
              ...
              try {
                pct2 = parseFloat(
                  document.querySelector(".sc-kpOJdX.jLZfGp.css-1s94otz")
                    .innerText,
                );
              } catch (e) {
                pct2 = 0;
